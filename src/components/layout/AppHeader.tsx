    ...
    <header className="h-12 bg-white border-b border-slate-200 px-4 flex items-center justify-between shrink-0 select-none shadow-2xs">
      ...
      <div className="flex items-center gap-3">
        ...
        >
          ...
          {conflictCount > 0 && (
            <span className="absolute -top-1 -right-1 min-w-[16px] h-[16px] px-1 bg-red-600 text-white rounded-full text-[10px] font-black flex items-center justify-center ring-2 ring-white shadow-xs">
              {conflictCount}
            </span>
          )}
        </button>
        ...
        <div className="flex items-center gap-1.5 bg-slate-100 p-1 rounded-lg border border-slate-200 text-xs sm:text-sm">
          ...
          <select
            ...
            className="bg-white border border-slate-300 rounded px-2 py-0.5 font-bold text-slate-800 cursor-pointer focus:outline-hidden focus:ring-1 focus:ring-blue-500 text-xs sm:text-sm"
          >
